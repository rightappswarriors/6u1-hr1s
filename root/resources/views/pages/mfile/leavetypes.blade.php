									...
									<tbody>
										@isset($otherearnings)
											@if(count($otherearnings)>0)
												...
												<tr data_id="{{$pp->code}}" data_name="{{$pp->description}}" data_le_lmt="{{$pp->leave_limit}}" data_carry_over="{{$pp->carry_over}}">
													<td>{{$pp->code}}</td>
							...
							<div class="row">
								<div class="col"> <!-- Column 1 -->
									...
									<div class="form-group">
										...
										<input type="number" name="txt_limit" step="0.01" style="text-transform: uppercase;" class="form-control" placeholder="LEAVE LIMIT" required>
									</div>
									<div class="form-group">
