...
@section('to-body')
	<div class="card">
		<div class="card-header">
			<i class="fa fa-clock-o"></i> Philhealth
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col">
				...
				<div class="modal-body">
					<form method="post" action="#" id="frm-pp" data="#">
						...
						<span class="AddMode">
							...
							<div class="row">
								<div class="col">
									...
									<div class="form-group">
										<label>Salary Base: <strong style="color:red">*</strong></label>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">{!!Core::currSign()!!}</div>
											</div>
											<input type="number" class="form-control VX RX" step=".01" name="txt_sal_bs" value="0.00" required="">
										</div>
									</div>
								</div>
								<div class="col">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control VX RX" step=".01" name="txt_emp_sh" value="0.00" required="">
										</div>
									</div>
									{{-- <div class="form-group">
						...
						<span class="DeleteMode">
							<p>Are you sure you want to delete <strong><span id="TOBEDELETED" style="color:red"></span></strong> from Philhealth list?</p>
						</span>
					</form>
				</div>
...
@section('to-bottom')
	...
	<script type="text/javascript">
		...
		$('#opt-add').on('click', function() {
			$('#frm-pp').attr('action', '{{url('master-file/philhealth')}}');
		...
		$('#opt-update').on('click', function() {
			$('#frm-pp').attr('action', '{{url('master-file/philhealth')}}/update');
			$('input[name="txt_code"]').attr('readonly', '');
			$.ajax({
				url : '{{ url('master-file/philhealth/getOne') }}',
				...
				success : function(data){
					...
					// 'empshare_ec' => $r->txt_eme_sh
							$('input[name="txt_sal_bs"]').val(d.salary_base);
							$('input[name="txt_emp_sh"]').val(d.emp_er).trigger('change');
		...
		$('#opt-delete').on('click', function() {
			$('#frm-pp').attr('action', '{{url('master-file/philhealth')}}/delete');
