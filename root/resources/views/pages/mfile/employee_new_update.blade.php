...
@section('to-body')
	<div class="card">
		<div class="card-header">
			<i class="fa fa-users"></i> Employee (Edit) <button type="button" class="btn btn-danger" onclick="location.href='{{ url('master-file/employee') }}';">Back</button>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col">
									  ...
									  <div class="tab-pane fade active show TestTabDiv" id="GEN_TAB_BDY" role="tabpanel" aria-labelledby="GEN_TAB">
									  	...
									  	<div class="row">
									  		<div class="col-sm-6">
											      ...
											      <div class="col-sm-8">
											      	<input type="text" name="txt_id" style="text-transform: uppercase;" class="form-control T0r" maxlength="8" value="@isset($MYDATA){{$MYDATA->empid}}@endisset" placeholder="Employee Number" required readonly="">
											      </div>
											    </div>
											    <div class="form-group row">
											      <label class="col-sm-4 col-form-label">Last Name <strong style="color:red">*</strong></label>
											      <div class="col-sm-8">
											      	<input type="text" class="form-control T0 T0r" name="txt_lname" placeholder="Last Name" required value="@isset($MYDATA){{$MYDATA->lastname}}@endisset">
											      </div>
											    </div>
											    <div class="form-group row">
											    ...
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_dept"]').val('{{$MYDATA->department}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
											    {{-- <div class="form-group row">
											    ...
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_jobdesc"]').val('{{$MYDATA->positions}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
										  	</div>
									  		...
									  		<div class="col-sm-7">
										  		<div class="row">
										  			<div class="col">
													      ...
													      <div class="col-sm-8">
													      	<input type="date" class="form-control T0r" name="txt_hired" required="" value="@isset($MYDATA){{$MYDATA->date_hired}}@endisset">
													      </div>
													    </div>
													    <div class="form-group row">
													      ...
													      <div class="col-sm-6">
													      	<input type="date" class="form-control" name="txt_con_dt"  @isset($MYDATA) @if($MYDATA->contractual_date != null) value="{{$MYDATA->contractual_date}}" @else disabled=""  @endif @endisset>
													      </div>
													    </div>
													    <div class="form-group row">
													    	<div class="col-sm-6 form-check">
														    ...
														    <div class="col-sm-6">
														     	<input type="date" class="form-control" name="txt_prob_dt" @isset($MYDATA) @if($MYDATA->prohibition_date != null) value="{{$MYDATA->prohibition_date}}" @else disabled=""  @endif @endisset>
														    </div>
													    </div>
													    <div class="form-group row">
													      <div class="col-sm-6 form-check">
													      ...
													      <div class="col-sm-6">
													      	<input type="date" class="form-control" name="txt_reg_dt" @isset($MYDATA) @if($MYDATA->date_regular != null) value="{{$MYDATA->date_regular}}" @else disabled=""  @endif @endisset>
													      </div>
													    </div>
										  			</div>
										  			<div class="col">
													      ...
													      <div class="col-sm-6">
													      	<input type="date" class="form-control" name="txt_resign_dt" @isset($MYDATA) @if($MYDATA->date_resigned != null) value="{{$MYDATA->date_resigned}}" @else disabled=""  @endif @endisset>
													      </div>
													    </div>
													    <div class="form-group row">
													      <div class="col-sm-6 form-check">
													      ...
													      <div class="col-sm-6">
													      	<input type="date" class="form-control" name="txt_termi_dt" @isset($MYDATA) @if($MYDATA->date_terminated != null) value="{{$MYDATA->date_terminated}}" @else disabled=""  @endif @endisset>
													      </div>
													    </div>
										  			</div>
										  		</div>
											      ...
											      <div class="col-sm-9">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_emp_stat"]').val('{{$MYDATA->empstatus}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
											    <div class="row">
											    	<div class="col">
											    		<div class="form-group row">
													      ...
													      <div class="col-sm-8">
													      	<input type="number" class="form-control" name="txt_contract" value="@isset($MYDATA){{$MYDATA->contract_days}}@endisset">
													      </div>
													    </div>
											    	</div>
											    	<div class="col">&nbsp;</div>
											    		...
											    		<div class="form-group row">
											    			<label class="col-sm-4 col-form-label">Rate Type <strong style="color:red">*</strong></label>
														      <div class="col-sm-8">
														      	...
														      	@isset($MYDATA)
																	<script>$('select[name="txt_rate_typ"]').val('{{$MYDATA->rate_type}}').trigger('change');</script>
														      	@endisset
														      </div>
											    		</div>
											    	</div>
											    	<div class="col-sm-4">
											    		<div class="form-group row">
													      <div class="col-sm-12 form-check">
													      	<input type="checkbox"  name="txt_fx_rate" value="true" @isset($MYDATA) @if($MYDATA->fixed_rate == '1') checked="checked" @endif @endisset  aria-label="...">
										  	...
										  	<div class="col-sm-5">
											    ...
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_tax_brac"]').val('{{$MYDATA->tax_bracket}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_ss_brac"]').val('{{$MYDATA->sss_bracket}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" onclick="FixSched()" name="txt_fx_sched" id="inlineRadio1" value="Yes" @isset($MYDATA) @if($MYDATA->fixed_sched == 'Y') checked="checked" @endif @endisset>
														<label class="form-check-label" for="inlineRadio1">Yes</label>
													</div>
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" onclick="FixSched()" name="txt_fx_sched" id="inlineRadio2" value="No" @isset($MYDATA) @if($MYDATA->fixed_sched != 'Y') checked="checked" @endif @endisset>
											    ...
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
														<div class="row">
															<div class="col-sm-5">
																{{-- shift_sched_from --}}
																<input type="time" class="form-control isFix mustReq" name="txt_sft_1" value="@isset($MYDATA) {{$MYDATA->shift_sched_from}} @endisset" disabled="">
															</div>
															<div class="col-sm-2"><center>-</center></div>
															<div class="col-sm-5">
																<input type="time" class="form-control isFix mustReq" name="txt_sft_2" value="@isset($MYDATA) {{$MYDATA->shift_sched_to}} @endisset" disabled="">
															</div>
														</div>
											      </div>
											    </div>
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
														<div class="row">
															<div class="col-sm-5">
																<input type="time" class="form-control isFix" name="txt_sat_sft_1" value="@isset($MYDATA) {{$MYDATA->shift_sched_sat_from}} @endisset" disabled="">
															</div>
															<div class="col-sm-2"><center>-</center></div>
															<div class="col-sm-5">
																<input type="time" class="form-control isFix" name="txt_sat_sft_2" value="@isset($MYDATA) {{$MYDATA->shift_sched_sat_to}} @endisset" disabled="">
															</div>
														</div>
											      </div>
											    </div>
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_day_off_1"]').val('{{$MYDATA->dayoff1}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
											    <div class="form-group row">
											      ...
											      <div class="col-sm-8">
											      	...
											      	@isset($MYDATA)
														<script>$('select[name="txt_day_off_2"]').val('{{$MYDATA->dayoff2}}').trigger('change');</script>
											      	@endisset
											      </div>
											    </div>
										  	</div>
									  	...
									  	<div class="row">
									  		<div class="col">
											    ...
											    <div class="form-group row">
											      	...
											      	<div class="col-sm-8">
											      		<input type="date" class="form-control navbar-expand-md T0r" name="txt_dt_birth" value="@isset($MYDATA){{$MYDATA->birth}}@endisset" required="">
											      	</div>
											    </div>
											    <div class="form-group row">
